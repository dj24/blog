...
const dotLottiePath = path.join(assetDirectory, "square.lottie");
...
const getLottiePageData = async () => {
  ...
  if (!animation) {
    throw new Error(`Animation ${animationId} was not found in ${path.basename(dotLottiePath)}.`);
  }
        ...
        <section className={styles.dataPanel}>
          ...
          <div className={styles.schemaLayout}>
            <SchemaSection title="composition" badge={`${compositionAttributes.length} attributes`}>
              <SchemaBlock title="root composition" badge={animationId}>
                <AttributeList
